        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2 p-4 bg-slate-900 rounded-lg">
            <Checkbox 
              ...
              onCheckedChange={(checked) => setFormData({ ...formData, healthCheck: checked as boolean })}
            />
          ...
          <div className="flex gap-3 pt-4">
            ...
            <Button onClick={handleDeploy} className="flex-1 bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600">
              Deploy
            </Button>
          </div>
        </div>
