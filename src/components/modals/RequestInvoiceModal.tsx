          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent className="bg-slate-800 border-slate-700 text-white">
                <SelectItem value="ORD-2845">
                  ORD-2845 - Engine Components
                </SelectItem>
                <SelectItem value="ORD-2846">
                  ORD-2846 - Brake Systems
                </SelectItem>
                <SelectItem value="ORD-2847">
                  ORD-2847 - Electrical Wiring
                </SelectItem>
                <SelectItem value="ORD-2848">
                  ORD-2848 - Suspension Parts
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
