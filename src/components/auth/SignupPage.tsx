...
export function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Email Signup attempt:", { email, password });
    alert("Email signup successful! (Demo)");
    navigate("/login");
  };

  const handleSocialSignup = (provider: string) => {
    console.log(`${provider} signup initiated.`);
    alert(`${provider} signup successful! (Demo)`);
    navigate("/dashboard"); // Redirect to dashboard after social signup
  };
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="hidden lg:flex flex-col justify-center p-12 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-700">
            ...
            <p className="text-lg text-slate-300 mb-8">
              Create your account to unlock powerful tools and insights for your enterprise.
            </p>
          ...
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-700 p-8 lg:p-12">
            <div className="lg:hidden mb-8">
              ...
              <h2 className="text-3xl text-white mb-2">Sign Up</h2>
              <p className="text-slate-400">Create your account</p>
            </div>

            <div className="hidden lg:block mb-8">
              <h2 className="text-3xl text-white mb-2">Sign Up</h2>
              <p className="text-slate-400">Start your digital transformation journey</p>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-slate-700">
              <p className="text-slate-400 text-sm mb-4">Or sign up with:</p>
              <div className="flex items-center justify-center gap-4">
                <button 
                  onClick={() => handleSocialSignup("Google")}
                  className="w-12 h-12 bg-slate-700/50 hover:bg-slate-700 border border-slate-600 rounded-full flex items-center justify-center text-slate-300 transition-colors"
                >
